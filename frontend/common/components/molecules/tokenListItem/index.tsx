...
export const TokenListItem = ({
  ...
  const [primaryColor, setPrimaryColor] = useState('violets-are-blue')
    ...
    <motion.div
      ...
      <Link
        ...
        className={cn(
          ...
          "rounded-3xl group border border-eerie-black/25 h-auto w-full relative shadow-md hover:-translate-y-1 delay-75 overflow-hidden ease-in-out transition-transform duration-1000 text-left justify-between group flex flex-col",
        )}
      >
        <div
